...
public struct BolusDeliveryTable {
    ...
    public init(units: Double, extendedUnits: Double = 0.0, extendedDuration: TimeInterval = 0) {
        ...
        entries = generateBolusTable(immediatePulses: immediatePulses, extendedPulses: extendedPulses, extendedDuration: duration)
    }
...
private func generateBolusTable(
    immediatePulses: Int,
    extendedPulses: Int,
...
private func computeExtendedPulsesPerSeg(extendedPulses: Int, duration: TimeInterval) -> [Int] {
...
private func numAltPairMatch(ePulsesPerSeg: [Int], idx: Int, val: Int) -> Int {
    var cnt = 0
...
private func numMatch(ePulsesPerSeg: [Int], idx: Int, val: Int) -> Int {
    var cnt = 0
