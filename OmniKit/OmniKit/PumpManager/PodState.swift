...
public struct PodState: RawRepresentable, Equatable, CustomDebugStringConvertible {
    ...
    )
    {
        ...
        nonceState = NonceState(lot: lot, tid: tid)
        ...
        messageTransportState = MessageTransportState(packetNumber: packetNumber, messageNumber: messageNumber)
        primeFinishTime = nil
    ...
    public init?(rawValue: RawValue) {
           ...
           let messageTransportState = MessageTransportState(rawValue: messageTransportStateRaw)
        {
            ...
            messageTransportState = MessageTransportState(packetNumber: 0, messageNumber: 0)
        }
...
private struct NonceState: RawRepresentable, Equatable {
    public typealias RawValue = [String: Any]
