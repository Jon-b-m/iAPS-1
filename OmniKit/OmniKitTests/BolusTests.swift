...
class BolusTests: XCTestCase {
    func testPrimeBolusCommand() {
        ...
        // Encode
        let cmd = SetInsulinScheduleCommand(
            nonce: 0xBED2_E16B,
            units: Pod.primeUnits,
            timeBetweenPulses: Pod.secondsPerPrimePulse
        )
    ...
    func testExtendedBolus() {
        ...
        do {
            let insulinCmd =
                try SetInsulinScheduleCommand(encodedData: Data(hexadecimalString: "1a100375a60202001703000000000000100a")!)
            XCTAssertEqual(0x0375_A602, insulinCmd.nonce)
    ...
    func testNoImmediateExtendedBolusDeliveryEncoding() {
        ...
        let bolus_1_00U_Ext_4_5Hr = SetInsulinScheduleCommand(
            nonce: 0xB93C_64F6,
            units: 0.0,
            extendedUnits: 1.0,
            extendedDuration: .hours(4.5)
        )
        ...
        let bolus_0_05U_Ext_0_5Hr = SetInsulinScheduleCommand(
            nonce: 0x0518_1992,
            units: 0.0,
            extendedUnits: 0.05,
            extendedDuration: .hours(0.5)
        )
        ...
        let bolus_0_10U_Ext_1Hr = SetInsulinScheduleCommand(
            nonce: 0x0621_1961,
            units: 0.0,
            extendedUnits: 0.10,
            extendedDuration: .hours(1)
        )
        ...
        let bolus_0_10U_Ext_1_5Hr = SetInsulinScheduleCommand(
            nonce: 0x0812_1964,
            units: 0.0,
            extendedUnits: 0.10,
            extendedDuration: .hours(1.5)
        )
        ...
        let bolus_0_10U_Ext_2Hr = SetInsulinScheduleCommand(
            nonce: 0x0411_1967,
            units: 0.0,
            extendedUnits: 0.10,
            extendedDuration: .hours(2)
        )
        ...
        let bolus_0_15U_Ext_1Hr = SetInsulinScheduleCommand(
            nonce: 0x0518_1983,
            units: 0.0,
            extendedUnits: 0.15,
            extendedDuration: .hours(1)
        ...
        let bolus_0_35U_Ext_0_5Hr = SetInsulinScheduleCommand(
            nonce: 0x0615_1215,
            units: 0.0,
            extendedUnits: 0.35,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_35U_Ext_4_5Hr = SetInsulinScheduleCommand(
            nonce: 0x0721_1946,
            units: 0.0,
            extendedUnits: 0.35,
            extendedDuration: .hours(4.5)
        ...
        let bolus_0_35U_Ext_5_0Hr = SetInsulinScheduleCommand(
            nonce: 0x0323_1932,
            units: 0.0,
            extendedUnits: 0.35,
            extendedDuration: .hours(5.0)
        )
        ...
        let bolus_0_35U_Ext_5_5Hr = SetInsulinScheduleCommand(
            nonce: 0x0301_1936,
            units: 0.0,
            extendedUnits: 0.35,
            extendedDuration: .hours(5.5)
        )
        XCTAssertEqual(
            "1a1c030119360200130c0000000010000001180000011800000118000001",
            bolus_0_35U_Ext_5_5Hr.data.hexadecimalString
        )
        ...
        let bolus_0_35U_Ext_6_0Hr = SetInsulinScheduleCommand(
            nonce: 0x0323_1957,
            units: 0.0,
            extendedUnits: 0.35,
            extendedDuration: .hours(6.0)
        )
        ...
        let bolus_0_35U_Ext_6_5Hr = SetInsulinScheduleCommand(
            nonce: 0x0815_1959,
            units: 0.0,
            extendedUnits: 0.35,
            extendedDuration: .hours(6.5)
        )
        ...
        let bolus_0_35U_Ext_7_0Hr = SetInsulinScheduleCommand(
            nonce: 0x1204_1962,
            units: 0.0,
            extendedUnits: 0.35,
            extendedDuration: .hours(7.0)
        )
    ...
    func testBolusDualWave() {
        ...
        do {
            let insulinCmd =
                try SetInsulinScheduleCommand(
                    encodedData: Data(hexadecimalString: "1a1601e475cb02012907028000280028100d000e100d000e")!
                )
            XCTAssertEqual(0x01E4_75CB, insulinCmd.nonce)
            let schedule = insulinCmd.deliverySchedule
            switch schedule {
            case let .bolus(units, timeBetweenPulses, table):
        ...
        let cmd = BolusExtraCommand(
            units: 0.05,
            timeBetweenPulses: Pod.secondsPerBolusPulse,
            extendedUnits: 0.05,
            extendedDuration: .hours(0.5),
            programReminderInterval: .minutes(60)
        )
    ...
    func testLargeExtendedBolus() {
        ...
        do {
            let insulinCmd =
                try SetInsulinScheduleCommand(encodedData: Data(hexadecimalString: "1a10031719580200fd0d000000000000b014")!)
            XCTAssertEqual(0x0317_1958, insulinCmd.nonce)
            let schedule = insulinCmd.deliverySchedule
            switch schedule {
            case let .bolus(units, timeBetweenPulses, table):
                XCTAssertEqual(0.0, units)
    ...
    func testLargeBolusDualWave() {
        ...
        do {
            ...
            let insulinCmd =
                try SetInsulinScheduleCommand(
                    encodedData: Data(hexadecimalString: "1a1e111619880202691112c0012c012c18121013181210131812101318121013")!
                )
            XCTAssertEqual(0x1116_1988, insulinCmd.nonce)
            let schedule = insulinCmd.deliverySchedule
            switch schedule {
            case let .bolus(units, timeBetweenPulses, table):
    ...
    func testDualBolusDeliveryEncoding() {
        ...
        let bolus_0_10U_50P_ext_30min = SetInsulinScheduleCommand(
            nonce: 0x0323_1932,
            units: 0.05,
            extendedUnits: 0.05,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_10U_50P_ext_60min = SetInsulinScheduleCommand(
            nonce: 0x0301_1936,
            units: 0.05,
            extendedUnits: 0.05,
            extendedDuration: .hours(1.0)
        )
        ...
        let bolus_0_15U_65P_ext_30min = SetInsulinScheduleCommand(
            nonce: 0x0317_1958,
            units: 0.05,
            extendedUnits: 0.10,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_15U_65P_ext_60min = SetInsulinScheduleCommand(
            nonce: 0x0815_1959,
            units: 0.05,
            extendedUnits: 0.10,
            extendedDuration: .hours(1.0)
        ...
        let bolus_0_15U_65P_ext_90min = SetInsulinScheduleCommand(
            nonce: 0x0621_1961,
            units: 0.05,
            extendedUnits: 0.10,
            extendedDuration: .hours(1.5)
        ...
        let bolus_0_15U_65P_ext_120min = SetInsulinScheduleCommand(
            nonce: 0x1204_1962,
            units: 0.05,
            extendedUnits: 0.10,
            extendedDuration: .hours(2.0)
        )
        ...
        let bolus_0_20U_75P_ext_30min = SetInsulinScheduleCommand(
            nonce: 0x0812_1964,
            units: 0.05,
            extendedUnits: 0.15,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_20U_75P_ext_60min = SetInsulinScheduleCommand(
            nonce: 0x0411_1967,
            units: 0.05,
            extendedUnits: 0.15,
            extendedDuration: .hours(1.0)
        ...
        let bolus_0_20U_75P_ext_90min = SetInsulinScheduleCommand(
            nonce: 0x0930_1968,
            units: 0.05,
            extendedUnits: 0.15,
            extendedDuration: .hours(1.5)
        ...
        let bolus_0_20U_75P_ext_120min = SetInsulinScheduleCommand(
            nonce: 0x0727_1971,
            units: 0.05,
            extendedUnits: 0.15,
            extendedDuration: .hours(2.0)
        ...
        let bolus_0_20U_75P_ext_150min = SetInsulinScheduleCommand(
            nonce: 0x0309_1975,
            units: 0.05,
            extendedUnits: 0.15,
            extendedDuration: .hours(2.5)
        )
        ...
        let bolus_0_20U_75P_ext_180min = SetInsulinScheduleCommand(
            nonce: 0x0124_2016,
            units: 0.05,
            extendedUnits: 0.15,
            extendedDuration: .hours(3.0)
        )
        ...
        let bolus_0_25U_80P_ext_30min = SetInsulinScheduleCommand(
            nonce: 0x0321_1983,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_25U_80P_ext_60min = SetInsulinScheduleCommand(
            nonce: 0x1104_1986,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(1.0)
        ...
        let bolus_0_25U_80P_ext_90min = SetInsulinScheduleCommand(
            nonce: 0x0506_1987,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(1.5)
        ...
        let bolus_0_25U_80P_ext_120min = SetInsulinScheduleCommand(
            nonce: 0x1020_1988,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(2.0)
        ...
        let bolus_0_25U_80P_ext_150min = SetInsulinScheduleCommand(
            nonce: 0x0705_1989,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(2.5)
        ...
        let bolus_0_25U_80P_ext_180min = SetInsulinScheduleCommand(
            nonce: 0x0906_1990,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(3.0)
        ...
        let bolus_0_25U_80P_ext_210min = SetInsulinScheduleCommand(
            nonce: 0x0906_1990,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(3.5)
        )
        ...
        let bolus_0_25U_80P_ext_240min = SetInsulinScheduleCommand(
            nonce: 0x0131_1991,
            units: 0.05,
            extendedUnits: 0.20,
            extendedDuration: .hours(4.0)
        )
        ...
        let bolus_0_15U_30P_ext_30min = SetInsulinScheduleCommand(
            nonce: 0x0507_1991,
            units: 0.10,
            extendedUnits: 0.05,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_15U_30P_ext_60min = SetInsulinScheduleCommand(
            nonce: 0x0831_1995,
            units: 0.10,
            extendedUnits: 0.05,
            extendedDuration: .hours(1.0)
        ...
        let bolus_0_20U_50P_ext_30min = SetInsulinScheduleCommand(
            nonce: 0x1006_1995,
            units: 0.10,
            extendedUnits: 0.10,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_20U_50P_ext_60min = SetInsulinScheduleCommand(
            nonce: 0x0713_2004,
            units: 0.10,
            extendedUnits: 0.10,
            extendedDuration: .hours(1.0)
        ...
        let bolus_0_20U_50P_ext_90min = SetInsulinScheduleCommand(
            nonce: 0x0219_2008,
            units: 0.10,
            extendedUnits: 0.10,
            extendedDuration: .hours(1.5)
        ...
        let bolus_0_20U_50P_ext_120min = SetInsulinScheduleCommand(
            nonce: 0x1009_2008,
            units: 0.10,
            extendedUnits: 0.10,
            extendedDuration: .hours(2.0)
        ...
        let bolus_0_25U_60P_ext_30min = SetInsulinScheduleCommand(
            nonce: 0x0622_2009,
            units: 0.10,
            extendedUnits: 0.15,
            extendedDuration: .hours(0.5)
        ...
        let bolus_0_25U_60P_ext_60min = SetInsulinScheduleCommand(
            nonce: 0x0712_2009,
            units: 0.10,
            extendedUnits: 0.15,
            extendedDuration: .hours(1.0)
        ...
        let bolus_0_25U_60P_ext_90min = SetInsulinScheduleCommand(
            nonce: 0x0810_2009,
            units: 0.10,
            extendedUnits: 0.15,
            extendedDuration: .hours(1.5)
        ...
        let bolus_0_25U_60P_ext_120min = SetInsulinScheduleCommand(
            nonce: 0x0716_2010,
            units: 0.10,
            extendedUnits: 0.15,
            extendedDuration: .hours(2.0)
        ...
        let bolus_0_25U_60P_ext_150min = SetInsulinScheduleCommand(
            nonce: 0x0807_2010,
            units: 0.10,
            extendedUnits: 0.15,
            extendedDuration: .hours(2.5)
        ...
        let bolus_0_25U_60P_ext_180min = SetInsulinScheduleCommand(
            nonce: 0x0506_2012,
            units: 0.10,
            extendedUnits: 0.15,
            extendedDuration: .hours(3.0)
    ...
    func test_30U_100P_ext() {
        ...
        do {
            ...
            let bolus30U_100P_ext_30min = SetInsulinScheduleCommand(
                nonce: 0x494E_532E,
                units: 0.0,
                extendedUnits: 30,
                extendedDuration: .hours(0.5)
            ...
            let bolus30U_100P_ext_30min_encoded =
                try SetInsulinScheduleCommand(encodedData: Data(
                    hexadecimalString: bolus30U_100P_ext_30min.data
                        .hexadecimalString
                )!)
            XCTAssertEqual(0x494E_532E, bolus30U_100P_ext_30min_encoded.nonce)
            ...
            let bolus30U_100P_ext_30min_extra_encoded =
                try BolusExtraCommand(encodedData: Data(hexadecimalString: bolus30U_100P_ext_30min_extra.data.hexadecimalString)!)
    ...
    func test_30U_75P_ext() {
        ...
        do {
            ...
            let bolus30U_75P_ext_30min = SetInsulinScheduleCommand(
                nonce: 0x494E_532E,
                units: 7.5,
                extendedUnits: 22.5,
                extendedDuration: .hours(0.5)
            ...
            let bolus30U_75P_ext_30min_encoded =
                try SetInsulinScheduleCommand(encodedData: Data(
                    hexadecimalString: bolus30U_75P_ext_30min.data
                        .hexadecimalString
                )!)
            XCTAssertEqual(0x494E_532E, bolus30U_75P_ext_30min_encoded.nonce)
            ...
            let bolus30U_75P_ext_30min_extra_encoded =
                try BolusExtraCommand(encodedData: Data(hexadecimalString: bolus30U_75P_ext_30min_extra.data.hexadecimalString)!)
    ...
    func test_30U_50P_ext() {
        ...
        do {
            ...
            let bolus30U_50P_ext_30min = SetInsulinScheduleCommand(
                nonce: 0x494E_532E,
                units: 15.0,
                extendedUnits: 15.0,
                extendedDuration: .hours(0.5)
            ...
            let bolus30U_50P_ext_30min_encoded =
                try SetInsulinScheduleCommand(encodedData: Data(
                    hexadecimalString: bolus30U_50P_ext_30min.data
                        .hexadecimalString
                )!)
            XCTAssertEqual(0x494E_532E, bolus30U_50P_ext_30min_encoded.nonce)
            ...
            let bolus30U_50P_ext_30min_extra_encoded =
                try BolusExtraCommand(encodedData: Data(hexadecimalString: bolus30U_50P_ext_30min_extra.data.hexadecimalString)!)
    ...
    func test_30U_25P_ext() {
        ...
        do {
            ...
            let bolus30U_25P_ext_30min = SetInsulinScheduleCommand(
                nonce: 0x494E_532E,
                units: 22.5,
                extendedUnits: 7.5,
                extendedDuration: .hours(0.5)
            ...
            let bolus30U_25P_ext_30min_encoded =
                try SetInsulinScheduleCommand(encodedData: Data(
                    hexadecimalString: bolus30U_25P_ext_30min.data
                        .hexadecimalString
                )!)
            XCTAssertEqual(0x494E_532E, bolus30U_25P_ext_30min_encoded.nonce)
            ...
            let bolus30U_25P_ext_30min_extra_encoded =
                try BolusExtraCommand(encodedData: Data(hexadecimalString: bolus30U_25P_ext_30min_extra.data.hexadecimalString)!)
    ...
    func test_1U_immediate_9123secs_remaining() {
        ...
        do {
            ...
            let nonce: UInt32 = 0xD303_9C04
            let immediateUnits = 1.0
            let remainingExtendedUnits = 0.75
            let remainingExtendedBolusTime: TimeInterval = .seconds(9123)

            let bolus_1U_immediate_9123secs_remaining = SetInsulinScheduleCommand(
                nonce: nonce,
                units: immediateUnits,
                extendedUnits: remainingExtendedUnits,
                extendedDuration: remainingExtendedBolusTime
            )
            XCTAssertEqual(
                "1a14d3039c0402007f07014000140014180220030001",
                bolus_1U_immediate_9123secs_remaining.data.hexadecimalString
            )

            let bolus_1U_immediate_9123secs_remaining_encoded =
                try SetInsulinScheduleCommand(encodedData: Data(
                    hexadecimalString: bolus_1U_immediate_9123secs_remaining.data
                        .hexadecimalString
                )!)
            ...
            let bolus_1U_immediate_9123secs_remaining_extra = BolusExtraCommand(
                units: immediateUnits,
                extendedUnits: remainingExtendedUnits,
                extendedDuration: remainingExtendedBolusTime
            )
            XCTAssertEqual("170d0000c800030d40009603a00a20", bolus_1U_immediate_9123secs_remaining_extra.data.hexadecimalString)
            let bolus_1U_immediate_9123secs_remaining_extra_encoded =
                try BolusExtraCommand(encodedData: Data(
                    hexadecimalString: bolus_1U_immediate_9123secs_remaining_extra.data
                        .hexadecimalString
                )!)
    ...
    func test_1U_immediate_3363secs_remaining() {
        ...
        do {
            ...
            let nonce: UInt32 = 0x1304_DE22
            let immediateUnits = 1.0
            let remainingExtendedUnits = 0.3
            let remainingExtendedBolusTime: TimeInterval = .seconds(3363)

            let bolus_1U_immediate_3363secs_remaining = SetInsulinScheduleCommand(
                nonce: nonce,
                units: immediateUnits,
                extendedUnits: remainingExtendedUnits,
                extendedDuration: remainingExtendedBolusTime
            ...
            let bolus_1U_immediate_3363secs_remaining_encoded =
                try SetInsulinScheduleCommand(encodedData: Data(
                    hexadecimalString: bolus_1U_immediate_3363secs_remaining.data
                        .hexadecimalString
                )!)
            ...
            let bolus_1U_immediate_3363secs_remaining_extra = BolusExtraCommand(
                units: immediateUnits,
                extendedUnits: remainingExtendedUnits,
                extendedDuration: remainingExtendedBolusTime
            )
            XCTAssertEqual("170d0000c800030d40003c03574150", bolus_1U_immediate_3363secs_remaining_extra.data.hexadecimalString)
            let bolus_1U_immediate_3363secs_remaining_extra_encoded =
                try BolusExtraCommand(encodedData: Data(
                    hexadecimalString: bolus_1U_immediate_3363secs_remaining_extra.data
                        .hexadecimalString
                )!)
    ...
    func test_1U_immediate_382secs_remaining() {
        ...
        do {
            ...
            let nonce: UInt32 = 0x10BB_EA5C
            let immediateUnits = 1.0
            let remainingExtendedUnits = 0.05
            let remainingExtendedBolusTime: TimeInterval = .seconds(382)

            let bolus_1U_immediate_382secs_remaining = SetInsulinScheduleCommand(
                nonce: nonce,
                units: immediateUnits,
                extendedUnits: remainingExtendedUnits,
                extendedDuration: remainingExtendedBolusTime
            ...
            let bolus_1U_immediate_382secs_remaining_encoded =
                try SetInsulinScheduleCommand(encodedData: Data(
                    hexadecimalString: bolus_1U_immediate_382secs_remaining.data
                        .hexadecimalString
                )!)
            ...
            let bolus_1U_immediate_382secs_remaining_extra = BolusExtraCommand(
                units: immediateUnits,
                extendedUnits: remainingExtendedUnits,
                extendedDuration: remainingExtendedBolusTime
            )
            XCTAssertEqual("170d0000c800030d40000a0246e2c0", bolus_1U_immediate_382secs_remaining_extra.data.hexadecimalString)
            let bolus_1U_immediate_382secs_remaining_extra_encoded =
                try BolusExtraCommand(encodedData: Data(
                    hexadecimalString: bolus_1U_immediate_382secs_remaining_extra.data
                        .hexadecimalString
                )!)
    ...
    func testBolusExtraOddPulseCount() {
        ...
        let cmd = BolusExtraCommand(
            ...
            completionBeep: true,
            programReminderInterval: .hours(1)
        )
    ...
    func testBolusAndBolusExtraMatch() {
        ...
        let bolusAmount = 0.1
        let bolusCommand = SetInsulinScheduleCommand(nonce: 0x2430_85C8, units: bolusAmount)
    ...
    func testLargeBolus() {
        ...
        let bolusCommand = SetInsulinScheduleCommand(nonce: 0x3120_4BA7, units: bolusAmount)
    ...
    func testOddBolus() {
        ...
        let bolusCommand = SetInsulinScheduleCommand(nonce: 0xCF9E_81AC, units: bolusAmount)
    ...
    func testCancelBolusCommand() {
        do {
            ...
            XCTAssertEqual(0x4D91_F8FF, cmd.nonce)
        ...
        // Encode
        let cmd = CancelDeliveryCommand(nonce: 0x4D91_F8FF, deliveryType: .bolus, beepType: .beeeeeep)
