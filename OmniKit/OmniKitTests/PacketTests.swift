...
class PacketTests: XCTestCase {
    func testPacketData() {
        ...
        let packet = Packet(address: 0x1F01_482A, packetType: .pdm, sequenceNum: 13, data: msg.encoded())
    ...
    func testPacketDecoding() {
        do {
            ...
            XCTAssertEqual(0x1F01_482A, packet.address)
    ...
    func testPacketFragmenting() {
        let longMessageData =
            Data(
                hexadecimalString: "02cb5000c92162368024632d8029623f002c62320031623b003463320039633d003c63310041623e0044633200496340004c6333005163448101627c8104627c8109627c810c62198111627c811460198103fe"
            )!
        let packet = Packet(address: 0x1F01_482A, packetType: .pdm, sequenceNum: 13, data: longMessageData)
        ...
        let con1 = Packet(
            ...
            packetType: .con,
            sequenceNum: 14,
            data: longMessageData.subdata(in: 31 ..< longMessageData.count)
        )
        ...
        let con2 = Packet(
            ...
            packetType: .con,
            sequenceNum: 14,
            data: longMessageData.subdata(in: (31 + 31) ..< longMessageData.count)
        )
