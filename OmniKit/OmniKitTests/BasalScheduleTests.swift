...
class BasalScheduleTests: XCTestCase {
    ...
    func testSetBasalScheduleCommand() {
        do {
            ...
            let cmd =
                try SetInsulinScheduleCommand(encodedData: Data(hexadecimalString: "1a1277a055510000622b17080000f800f800f800")!)

            XCTAssertEqual(0x77A0_5551, cmd.nonce)
            if case let SetInsulinScheduleCommand.DeliverySchedule.basalSchedule(
                currentSegment,
                secondsRemaining,
                pulsesRemaining,
                table
            ) = cmd.deliverySchedule {
        ...
        let deliverySchedule = SetInsulinScheduleCommand.DeliverySchedule.basalSchedule(
            currentSegment: 0x2B,
            secondsRemaining: 737,
            pulsesRemaining: 0,
            table: table
        )
        let cmd = SetInsulinScheduleCommand(nonce: 0x77A0_5551, deliverySchedule: deliverySchedule)
    ...
    func testBasalScheduleCommandFromSchedule() {
        ...
        let cmd = SetInsulinScheduleCommand(nonce: 0x0102_0304, basalSchedule: schedule, scheduleOffset: .hours(8.25))

        XCTAssertEqual(0x0102_0304, cmd.nonce)
        if case let SetInsulinScheduleCommand.DeliverySchedule.basalSchedule(
            currentSegment,
            secondsRemaining,
            pulsesRemaining,
    ...
    func testBasalScheduleExtraCommand() {
        ...
        let cmd = BasalScheduleExtraCommand(
            currentEntryIndex: 0,
            remainingPulses: 689,
            delayUntilNextTenthOfPulse: TimeInterval(seconds: 20),
            rateEntries: rateEntries,
            acknowledgementBeep: false,
            completionBeep: true,
            programReminderInterval: 0
        )
    ...
    func testBasalScheduleExtraCommandFromSchedule() {
        ...
        let cmd = BasalScheduleExtraCommand(
            schedule: schedule,
            scheduleOffset: .hours(8.25),
            acknowledgementBeep: false,
            completionBeep: true,
            programReminderInterval: 60
        )
    ...
    func testBasalExtraEncoding() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0x0D66_12DB, basalSchedule: schedule, scheduleOffset: offset)
    ...
    func checkBasalScheduleExtraCommandDataWithLessPrecision(_ expected: Data, _ data: Data, line: UInt = #line) {
        ...
        func extractXXXXXXXX(_ data: Data) -> TimeInterval {
            TimeInterval(Double(data[6...].toBigEndian(UInt32.self)) / 1_000_000.0)
        }
    ...
    func testBasalExtraEncoding1() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0x2A84_5E17, basalSchedule: schedule, scheduleOffset: offset)
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(hexadecimalString: "130e40000688009cf29113b001059449")!,
            cmd2.data
        )
    }
    ...
    func testBasalExtraEncoding2() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0x0A22_9E93, basalSchedule: schedule, scheduleOffset: offset)
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(hexadecimalString: "130e40000519001a286513b001059449")!,
            cmd2.data
        )
    }
    ...
    func testSuspendBasalCommand() {
        do {
            ...
            XCTAssertEqual(0x6FED_E14A, cmd.nonce)
        ...
        // Encode
        let cmd = CancelDeliveryCommand(nonce: 0x6FED_E14A, deliveryType: .basal, beepType: .noBeepCancel)
    ...
    func testSegmentMerging() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0x8510_72AA, basalSchedule: schedule, scheduleOffset: offset)
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(
                hexadecimalString: "132c4005026200455b9c01e0015752a0016801312d0006a40143209601a401885e6d016801312d00037000f9b074"
            )!,
            cmd2.data
        )
    }
    ...
    func testRounding() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0xC2A3_2DA8, basalSchedule: schedule, scheduleOffset: offset)
    ...
    func testThirteenEntries() {
        ...
        let cmd = SetInsulinScheduleCommand(nonce: 0x8510_72AA, basalSchedule: schedule, scheduleOffset: offset)
        XCTAssertEqual(
            "1a2a851072aa0001dd2715180003000d280000111809700a180610052806100600072806001118101801e808",
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(
                hexadecimalString: "1356400c02c8011abc64008200d34689000f15752a0000aa00a1904b00550143209603840112a880008201a68d13006402255100008201a68d13007801c9c380014501a68d1301ef00a675a2001e07270e0004fb01432096"
            )!,
            cmd2.data
        )
    }
    ...
    func testJoe12Entries() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0xF36A_23A3, basalSchedule: schedule, scheduleOffset: offset)
        XCTAssertEqual(
            "1a2af36a23a30002351636480005000d280000111809700a180610052806100600072806001128100009e808",
            cmd1.data.hexadecimalString
        )
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(
                hexadecimalString: "13504008003a019bfcc0008200d34689000f15752a0000aa00a1904b00550143209603840112a880008201a68d13006402255100008201a68d13007801c9c380014501a68d13029400a675a2055001432096"
            )!,
            cmd2.data
        )
    }
    ...
    func testFunkyRates() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0xF36A_23A3, basalSchedule: schedule, scheduleOffset: offset)
        XCTAssertEqual(
            "1a2af36a23a3000291030ae80000000d280000111809700a180610052806100600072806001128100009e808",
            cmd1.data.hexadecimalString
        )
    }
    ...
    func test723ScheduleImport() {
        ...
        if Pod.zeroBasalRate == nearZeroBasalRate {
            ...
            let cmd1 = SetInsulinScheduleCommand(nonce: 0x494E_532E, basalSchedule: schedule, scheduleOffset: offset)
            ...
            checkBasalScheduleExtraCommandDataWithLessPrecision(
                Data(
                    hexadecimalString: "132c0005000f007a12000003eb49d200001415752a000001eb49d2000064044aa20000d201885e6d09ab016e3600"
                )!,
                cmd2.data
            )
        } else {
            ...
            let cmd1 = SetInsulinScheduleCommand(nonce: 0xEE29_DB98, basalSchedule: schedule, scheduleOffset: offset)
            ...
            checkBasalScheduleExtraCommandDataWithLessPrecision(
                Data(hexadecimalString: "1320000300a8001e8480002815752a000064044aa20000d201885e6d09ab016e3600")!,
                cmd2.data
            )
        }
    }
    ...
    func testBasalScheduleExtraCommandRoundsToNearestSecond() {
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(hexadecimalString: "130e400001c1006acfc012c00112a880")!,
            cmd.data
        )
    }
    ...
    func testLargeContinuousBasal() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0x0528_1983, basalSchedule: schedule, scheduleOffset: offset)
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(hexadecimalString: "13144000f2020003d090fd20000b71b0c4e0000b71b0")!,
            cmd2.data
        )
    }
    ...
    func testMaxContinuousBasal() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0x0614_1980, basalSchedule: schedule, scheduleOffset: offset)
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(hexadecimalString: "131a4000632b00061a80f618000927c0f618000927c04650000927c0")!,
            cmd2.data
        )
    }
}
