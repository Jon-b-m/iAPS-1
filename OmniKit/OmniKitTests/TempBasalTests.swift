...
//        XCTAssertEqual(0.15, OmnipodPumpManager.roundToDeliveryIncrement(units: 0.145))
    ...
    func testAlternatingSegmentFlag() {
        ...
        let cmd = SetInsulinScheduleCommand(nonce: 0x9746_C65B, tempBasalRate: 0.05, duration: .hours(0.5))
        ...
        let cmd2 = SetInsulinScheduleCommand(nonce: 0x9746_C65B, tempBasalRate: 0.05, duration: .hours(8.5))
        ...
        let cmd3 = SetInsulinScheduleCommand(nonce: 0x9746_C65B, tempBasalRate: 0.05, duration: .hours(16.5))
    ...
    func testTempBasalThreeTenthsUnitPerHour() {
        let cmd = SetInsulinScheduleCommand(nonce: 0xEAC7_9411, tempBasalRate: 0.3, duration: .hours(0.5))
    ...
    func testSetTempBasalCommand() {
        do {
            ...
            XCTAssertEqual(0xEA2D_0A3B, cmd.nonce)
            if case let SetInsulinScheduleCommand.DeliverySchedule.tempBasal(secondsRemaining, firstSegmentPulses, table) = cmd
                .deliverySchedule
            {
        ...
        // Encode
        let cmd = SetInsulinScheduleCommand(nonce: 0xEA2D_0A3B, tempBasalRate: 0.20, duration: .hours(0.5))
    ...
    func testSetTempBasalWithAlternatingPulse() {
        do {
            ...
            XCTAssertEqual(0x4E2C_2717, cmd.nonce)
            if case let SetInsulinScheduleCommand.DeliverySchedule.tempBasal(secondsRemaining, firstSegmentPulses, table) = cmd
                .deliverySchedule
            {
                XCTAssertEqual(1800, secondsRemaining)
        ...
        // Encode
        let cmd = SetInsulinScheduleCommand(nonce: 0x4E2C_2717, tempBasalRate: 0.05, duration: .hours(2.5))
    ...
    func testLargerTempBasalCommand() {
        do {
            ...
            XCTAssertEqual(0x87E8_D03A, cmd.nonce)
            if case let SetInsulinScheduleCommand.DeliverySchedule.tempBasal(secondsRemaining, firstSegmentPulses, table) = cmd
                .deliverySchedule
            {
                XCTAssertEqual(1800, secondsRemaining)
        ...
        // Encode
        let cmd = SetInsulinScheduleCommand(nonce: 0x87E8_D03A, tempBasalRate: 2, duration: .hours(1.5))
    ...
    func testCancelTempBasalCommand() {
        do {
            ...
            XCTAssertEqual(0xF76D_34C4, cmd.nonce)
        ...
        // Encode
        let cmd = CancelDeliveryCommand(nonce: 0xF76D_34C4, deliveryType: .tempBasal, beepType: .beeeeeep)
    ...
    func testCancelTempBasalnoBeepCommand() {
        ...
        // Encode
        let cmd = CancelDeliveryCommand(nonce: 0xF76D_34C4, deliveryType: .tempBasal, beepType: .noBeepCancel)
    ...
    func testZeroTempThreeHoursExtraCommand() {
        do {
            // 0 U/h for 3 hours
            let cmd =
                try TempBasalExtraCommand(
                    encodedData: Data(
                        hexadecimalString: "162c7c0000006b49d20000006b49d20000006b49d20000006b49d20000006b49d20000006b49d20000006b49d200"
                    )!
                )
            XCTAssertEqual(false, cmd.acknowledgementBeep)
            XCTAssertEqual(true, cmd.completionBeep)
    ...
    func testZeroTempTwelveHoursExtraCommand() {
        do {
            ...
            let cmd =
                try TempBasalExtraCommand(
                    encodedData: Data(
                        hexadecimalString: ""
                    )!
                )
            XCTAssertEqual(false, cmd.acknowledgementBeep)
            XCTAssertEqual(true, cmd.completionBeep)
    ...
    func testTempBasalExtremeValues() {
        do {
            ...
            XCTAssertEqual(0xA958_C5AD, cmd.nonce)
            if case let SetInsulinScheduleCommand.DeliverySchedule.tempBasal(secondsRemaining, firstSegmentPulses, table) = cmd
                .deliverySchedule
            {
                XCTAssertEqual(1800, secondsRemaining)
        ...
        // Encode
        let cmd = SetInsulinScheduleCommand(nonce: 0xA958_C5AD, tempBasalRate: 30, duration: .hours(12))
    ...
    func testBasalExtraCommandForOddPulseCountRate() {
        let cmd1 = TempBasalExtraCommand(
            rate: 0.05,
            duration: .hours(0.5),
            acknowledgementBeep: false,
            completionBeep: true,
        ...
        let cmd2 = TempBasalExtraCommand(
            rate: 2.05,
            duration: .hours(0.5),
            acknowledgementBeep: false,
        ...
        let cmd3 = TempBasalExtraCommand(
            rate: 2.10,
            duration: .hours(0.5),
            acknowledgementBeep: false,
            completionBeep: false,
        ...
        let cmd4 = TempBasalExtraCommand(
            rate: 2.15,
            duration: .hours(0.5),
            acknowledgementBeep: false,
            completionBeep: false,
    ...
    func testTempBasalExtraCommandExtremeValues() {
        do {
            ...
            let cmd =
                try TempBasalExtraCommand(encodedData: Data(hexadecimalString: "16143c00f618000927c0f618000927c02328000927c0")!)
            XCTAssertEqual(false, cmd.acknowledgementBeep)
    ...
    func testTempBasalExtraCommandExtremeValues2() {
        do {
            ...
            let cmd =
                try TempBasalExtraCommand(encodedData: Data(hexadecimalString: "16143c00f5af00092ba9f5af00092ba9231900092ba9")!)
            XCTAssertEqual(false, cmd.acknowledgementBeep)
            XCTAssertEqual(false, cmd.completionBeep)
            XCTAssertEqual(.minutes(60), cmd.programReminderInterval)
