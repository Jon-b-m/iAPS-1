...
final class G7GlucoseMessageTests: XCTestCase {
    ...
    func testG7MessageDataWithCalibration() {
        ...
        XCTAssertEqual(901_390, message.glucoseTimestamp)
        XCTAssert(message.glucoseIsDisplayOnly)
    }
    ...
    func testG7MessageDataLifecycle() {
        ...
        XCTAssertEqual(907_385, messages[8].glucoseTimestamp)
    }
    ...
    func testTwoByteAge() {
        ...
        XCTAssertEqual(154_105, message.messageTimestamp)
        XCTAssertEqual(153_807, message.glucoseTimestamp)
    }
    ...
    func testTwoByteAgeOnExpiredSensor() {
        ...
        XCTAssertEqual(934_989, message.messageTimestamp)
        XCTAssertEqual(907_385, message.glucoseTimestamp)
    }

    func testBackfill() {
        let data = Data(hexadecimalString: "cf5802008f00060f10")!
        let message = G7BackfillMessage(data: data)!
        XCTAssertEqual(153_807, message.timestamp)
    }
}
