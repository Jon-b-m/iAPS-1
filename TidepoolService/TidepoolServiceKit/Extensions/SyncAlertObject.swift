...
extension SyncAlertObject: IdentifiableDatum {
    func datum(for userId: String, hostIdentifier: String, hostVersion: String) -> TAlertDatum? {
        ...
        return datum.adornWith(
            id: datumId(for: userId),
            payload: datumPayload,
            origin: datumOrigin(
                for: resolvedIdentifier,
...
private extension SyncAlertObject {
    var triggered: Bool {
...
private extension Alert.Metadata {
