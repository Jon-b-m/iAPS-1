...
class DoseEntryDataTests: XCTestCase {
    ...
    func testDataBasal() {
        ...
        let data = doseEntry.data(
            for: "2B03D96C-6F5D-4140-99CD-80C3E64D6011",
            hostIdentifier: hostIdentifier,
            hostVersion: hostVersion
        )
        XCTAssertEqual(
            String(data: try! Self.encoder.encode(data), encoding: .utf8),
            """
            [
              {
...
class DoseEntrySelectorTests: XCTestCase {
    func testSelectorBasal() {
        ...
        XCTAssertEqual(
            doseEntry.selectors,
            [TDatum.Selector(origin: TDatum.Selector.Origin(id: "ab0a722d639669875017a899a5214677:basal/scheduled"))]
        )
    }
    ...
    func testSelectorBolusManuallyEntered() {
        ...
        XCTAssertEqual(
            doseEntry.selectors,
            [TDatum.Selector(origin: TDatum.Selector.Origin(id: "ab0a722d639669875017a899a5214677:insulin"))]
        )
    }
    ...
    func testSelectorBolusManual() {
        ...
        XCTAssertEqual(
            doseEntry.selectors,
            [TDatum.Selector(origin: TDatum.Selector.Origin(id: "ab0a722d639669875017a899a5214677:bolus/normal"))]
        )
    }
    ...
    func testSelectorBolusAutomatic() {
        ...
        XCTAssertEqual(
            doseEntry.selectors,
            [TDatum.Selector(origin: TDatum.Selector.Origin(id: "ab0a722d639669875017a899a5214677:bolus/automated"))]
        )
    }
    ...
    func testSelectorSuspend() {
        ...
        XCTAssertEqual(
            doseEntry.selectors,
            [TDatum.Selector(origin: TDatum.Selector.Origin(id: "ab0a722d639669875017a899a5214677:basal/suspend"))]
        )
    }
    ...
    func testSelectorTempBasalManual() {
        ...
        XCTAssertEqual(
            doseEntry.selectors,
            [TDatum.Selector(origin: TDatum.Selector.Origin(id: "ab0a722d639669875017a899a5214677:basal/temp"))]
        )
    }
    ...
    func testSelectorTempBasalAutomatic() {
        ...
        XCTAssertEqual(
            doseEntry.selectors,
            [TDatum.Selector(origin: TDatum.Selector.Origin(id: "ab0a722d639669875017a899a5214677:basal/automated"))]
        )
    }
