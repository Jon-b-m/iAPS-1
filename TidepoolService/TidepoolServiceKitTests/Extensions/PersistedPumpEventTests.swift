...
class PersistedPumpEventTests: XCTestCase {
    func testDataAlarm() {
        let pumpEvent = PersistedPumpEvent(
            date: Self.dateFormatter.date(from: "2020-01-02T03:00:23Z")!,
    ...
    func testDataAlarmWithSuspend() {
        let pumpEvent = PersistedPumpEvent(
            ...
            persistedDate: Self.dateFormatter.date(from: "2020-01-02T03:00:23Z")!,
            dose: DoseEntry(
                suspendDate: Self.dateFormatter.date(from: "2020-01-02T03:00:23Z")!,
                automatic: true
            ),
            isUploaded: false,
            objectIDURL: URL(string: "x-coredata:///PumpEvent/18CF3948-0B3D-4B12-8BFE-14986B0E6784")!,
    ...
    func testDataAlarmWithResume() {
        let pumpEvent = PersistedPumpEvent(
            ...
            persistedDate: Self.dateFormatter.date(from: "2020-01-02T03:00:23Z")!,
            dose: DoseEntry(
                resumeDate: Self.dateFormatter.date(from: "2020-01-02T03:00:23Z")!,
                automatic: true
            ),
            isUploaded: false,
            objectIDURL: URL(string: "x-coredata:///PumpEvent/18CF3948-0B3D-4B12-8BFE-14986B0E6784")!,
