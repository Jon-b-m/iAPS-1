...
class GlucoseBackfillMessageTests: XCTestCase {
    ...
    func testRxMessage() {
        ...
        XCTAssertEqual(5_439_415, message.startTime)
        XCTAssertEqual(5_440_614, message.endTime)
        ...
        XCTAssertEqual(5_439_415, messages[0].timestamp)
        ...
        XCTAssertEqual(5_439_715, messages[1].timestamp)
        ...
        XCTAssertEqual(5_440_015, messages[2].timestamp)
        ...
        XCTAssertEqual(5_440_314, messages[3].timestamp)
        ...
        XCTAssertEqual(5_440_614, messages[4].timestamp)
    ...
    func testGlucoseBackfill2() {
        ...
        XCTAssertEqual(
            Data(hexadecimalString: "50050200eaee4600c6f446000000000000009f6d")!,
            message.data,
        ...
        XCTAssertEqual(4_648_682, response.startTime)
        XCTAssertEqual(4_650_182, response.endTime)
    ...
    func testGlucoseBackfill3() {
        ...
        XCTAssertEqual(944_701, response.startTime)
        XCTAssertEqual(945_601, response.endTime)
    ...
    func testGlucoseBackfill4() {
        ...
        XCTAssertEqual(1, response.backfillStatus)
        XCTAssertEqual(3, response.identifier)
        XCTAssertEqual(947_401, response.startTime)
        XCTAssertEqual(948_301, response.endTime)
        XCTAssertEqual(40, response.bufferLength)
    ...
    func testNotGlucoseBackfill1() {
        ...
        XCTAssertEqual(1, response.backfillStatus)
        XCTAssertEqual(3, response.identifier)
        XCTAssertEqual(934_201, response.startTime)
        XCTAssertEqual(960_901, response.endTime)
    ...
    func testNotGlucoseBackfill2() {
        ...
        XCTAssertEqual(1, response.backfillStatus)
        XCTAssertEqual(2, response.identifier)
        XCTAssertEqual(961_201, response.startTime)
        XCTAssertEqual(963_301, response.endTime)
    ...
    func testNotGlucoseBackfill3() {
        ...
        XCTAssertEqual(1, response.backfillStatus)
        XCTAssertEqual(2, response.identifier)
        XCTAssertEqual(6_661_046, response.startTime)
        XCTAssertEqual(6_687_745, response.endTime)
        XCTAssertEqual(1708, response.bufferLength)
