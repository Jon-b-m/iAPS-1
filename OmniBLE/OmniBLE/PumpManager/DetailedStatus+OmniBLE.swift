...
public extension DetailedStatus {
    var pdmRef: String? {
        ...
        let HH = UInt8(timeActive.hours) // # of pod hours
        let III = UInt8(totalInsulinDelivered) // units of insulin
        let RR = UInt8(reservoirLevel) // reservoir units, special 50+ U value becomes 51 as needed
