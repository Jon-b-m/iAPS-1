...
public struct BasalStateSwiftUIView: UIViewRepresentable {
    ...
    public func makeUIView(context _: UIViewRepresentableContext<BasalStateSwiftUIView>) -> BasalStateView {
        let view = BasalStateView()
        view.netBasalPercent = netBasalPercent
        return view
    }

    public func updateUIView(_ uiView: BasalStateView, context _: UIViewRepresentableContext<BasalStateSwiftUIView>) {
