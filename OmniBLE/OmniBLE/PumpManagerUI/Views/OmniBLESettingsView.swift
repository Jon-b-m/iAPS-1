...
struct OmniBLESettingsView: View {
            ...
            Section {
                ...
                if let podDetails = self.viewModel.podDetails {
                    NavigationLink(destination: PodDetailsView(
                        ...
                        title: LocalizedString("Pod Details", comment: "title for pod details page")
                    )) {
                ...
                if let previousPodDetails = viewModel.previousPodDetails {
                    NavigationLink(destination: PodDetailsView(
                        ...
                        title: LocalizedString("Previous Pod", comment: "title for previous pod page")
                    )) {
            ...
            Section(header: SectionHeader(label: LocalizedString(
            ...
            )))
                {
                    NavigationLink(
                        ...
                        {
                            FrameworkLocalText("Notification Settings", comment: "Text for pod details disclosure row")
                                .foregroundColor(Color.primary)
                        }
    ...
    var removePumpManagerActionSheet: ActionSheet {
        ActionSheet(
            title: FrameworkLocalText("Remove Pump", comment: "Title for Omnipod DASH PumpManager deletion action sheet."),
            message: FrameworkLocalText(
                "Are you sure you want to stop using Omnipod DASH?",
                comment: "Message for Omnipod DASH PumpManager deletion action sheet"
            ),
            buttons: [
                .destructive(FrameworkLocalText(
                    "Delete Omnipod DASH",
                    comment: "Button text to confirm Omnipod DASH PumpManager deletion"
                )) {
