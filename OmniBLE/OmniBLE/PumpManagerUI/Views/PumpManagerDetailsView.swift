...
struct PumpManagerDetailsView: View {
    ...
    private let actionString = LocalizedString(
        "Retrieving Pump Manager Details...",
        comment: "button title when retrieving pump manager details"
    )
    private let buttonTitle = LocalizedString(
        "Refresh Pump Manager Details",
        comment: "button title to refresh pump manager details"
    )
...
struct PumpManagerDetailsView_Previews: PreviewProvider {
    static var previews: some View {
        let examplePumpManagerDetails: String =
