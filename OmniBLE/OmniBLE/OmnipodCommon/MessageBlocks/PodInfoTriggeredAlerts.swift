...
private func triggeredAlerts(
    podInfoTriggeredAlerts: PodInfoTriggeredAlerts,
    startOffset: Int,
    sepString: String,
    printAll: Bool
) -> String {
...
func triggeredAlertsString(podInfoTriggeredAlerts: PodInfoTriggeredAlerts) -> String {
    triggeredAlerts(podInfoTriggeredAlerts: podInfoTriggeredAlerts, startOffset: 27, sepString: "\n", printAll: false)
}

extension PodInfoTriggeredAlerts: CustomDebugStringConvertible {
    public var debugDescription: String {
        triggeredAlerts(podInfoTriggeredAlerts: self, startOffset: 33, sepString: ", ", printAll: true)
    }
}
