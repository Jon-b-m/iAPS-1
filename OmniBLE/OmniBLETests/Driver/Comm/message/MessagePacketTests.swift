...
class MessagePacketTests: XCTestCase {
    let payloadString =
        "54,57,11,01,07,00,03,40,08,20,2e,a8,08,20,2e,a9,ab,35,d8,31,60,9b,b8,fe,3a,3b,de,5b,18,37,24,9a,16,db,f8,e4,d3,05,e9,75,dc,81,7c,37,07,cc,41,5f,af,8a"
    ...
    func testParseMessagePacket() {
        ...
        assert(msg.source == Id.fromInt(136_326_824))
        assert(msg.destination == Id.fromInt(136_326_825))
    ...
    func testSerializeMessagePacket() {
        ...
        let msg = MessagePacket(
            type: .ENCRYPTED,
            source: Id.fromInt(136_326_824).toUInt32(),
            destination: Id.fromInt(136_326_825).toUInt32(),
            payload: payload,
            sequenceNumber: 0,
            ack: false,
            ackNumber: 0,
