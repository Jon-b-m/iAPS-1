...
class EnDecryptTest: XCTestCase {
    func testDecrypt() {
        let received =
            "54,57,11,a1,0c,16,03,00,08,20,2e,a9,08,20,2e,a8,34,7c,b9,7b,38,5d,45,a3,c4,0e,40,4c,55,71,5e,f3,c3,86,50,17,36,7e,62,3c,7d,0b,46,9e,81,cd,fd,9a"
        ...
        let enDecrypt = EnDecrypt(
            ...
            ck: Data(
                hexadecimalString: "55,79,9f,d2,66,64,cb,f6,e4,76,52,5e,2d,ee,52,c6"
    ...
    func testEncrypt() {
        ...
        let expectedEncryptedData = Data(
            hexadecimalString:
