...
class ZeroBasalScheduleTests: XCTestCase {
    ...
    func testZeroOneZeroSegment() {
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(hexadecimalString: "131a40020b19002dc6c000640112a8800001eb49d20011f80112a880")!,
            cmd2.data
        )
    }
    ...
    func testZeroMinBasal() {
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(hexadecimalString: "1314400000066769ffc0002eeb49d200000a15752a00")!,
            cmd2.data
        )
    }
    ...
    func testZeroSomeZeroBasal() {
        ...
        let cmd1 = SetInsulinScheduleCommand(nonce: 0x494E_532E, basalSchedule: schedule, scheduleOffset: offset)
        XCTAssertEqual(
            "1a24494e532e00018e2815180000b80a2000280700097806300020014800200200041803281b",
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(
                hexadecimalString: "134a4008001c02aea54004ec010594490003eb49d20000e1016e3600005501432096020801a68d130004eb49d200001e0aba9500001915752a00003c055d4a8000690310bcdb03390063e02e"
            )!,
            cmd2.data
        )
    }
    ...
    func testZeroBasalTest1() {
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(
                hexadecimalString: "133e4007000e03b20b800002eb49d200000a15752a000002eb49d200003c07270e000004eb49d2000050055d4a800004eb49d2000096044aa2000014eb49d200"
            )!,
            cmd2.data
        )
    }
    ...
    func testZeroBasalTest2() {
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(
                hexadecimalString: "133e4006000e01e848000002eb49d200000a15752a000002eb49d200007807270e000064044aa2000004eb49d2000096044aa2000006eb49d20001a403938700"
            )!,
            cmd2.data
        )
    }
    ...
    func testZeroBasalTest4() {
        ...
        checkBasalScheduleExtraCommandDataWithLessPrecision(
            Data(
                hexadecimalString: "133e400800153825c7800002eb49d200000a15752a000002eb49d200003c07270e000004eb49d2000050055d4a800004eb49d2000032044aa2000018eb49d200"
            )!,
            cmd2.data
        )
    }
