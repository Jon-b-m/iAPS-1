...
public struct MySentryPumpStatusMessageBody: DecodableMessageBody, MessageBody, DictionaryRepresentable {
    ...
    public init?(rxData: Data) {
        ...
        clockType = ((hourByte & 0b1000_0000) > 0) ? .twentyFourHour : .twelveHour
    ...
    public var dictionaryRepresentation: [String: Any] {
        ...
        dict["byte1High"] = String(format: "%02x", byte1 & 0b1111_0000)
        // {1}
        dict["byte1Low"] = Int(byte1 & 0b0000_0001)
...
public func == (lhs: MySentryPumpStatusMessageBody, rhs: MySentryPumpStatusMessageBody) -> Bool {
    lhs.pumpDateComponents == rhs.pumpDateComponents && lhs.glucoseDateComponents == rhs.glucoseDateComponents
}
