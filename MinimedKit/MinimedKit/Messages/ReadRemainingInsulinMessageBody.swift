...
public class ReadRemainingInsulinMessageBody: DecodableMessageBody {
    ...
    public var description: String {
        "ReadRemainingInsulin(x23:\(getUnitsRemaining(insulinBitPackingScale: PumpModel.model523.insulinBitPackingScale)), x22:\(getUnitsRemaining(insulinBitPackingScale: PumpModel.model522.insulinBitPackingScale)))"
    }
}
