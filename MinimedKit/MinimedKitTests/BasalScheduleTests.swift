...
class BasalScheduleTests: XCTestCase {
    ...
    func testDataFrameParsing() {
        ...
        XCTAssertEqual(
            ...
            frames[0].txData.hexadecimalString
        )
        XCTAssertEqual(
            ...
            frames[1].txData.hexadecimalString
        )
        XCTAssertEqual(
            ...
            frames[2].txData.hexadecimalString
        )
    ...
    func testEmptySchedule() {
        let emptyData =
            Data(
                hexadecimalString: ""
            )!
