...
class MySentryPumpStatusMessageBodyTests: XCTestCase {
    func testValidPumpStatusMessage() {
        let message =
            PumpMessage(
                rxData: Data(
                    hexadecimalString: "a2594040042f511727070f09050184850000cd010105b03e0a0a1a009d030000711726000f09050000"
                )!
            )
    ...
    func testGlucoseTrendFlat() {
        XCTAssertEqual(GlucoseTrend.flat, GlucoseTrend(byte: 0b0000_0000))
        XCTAssertEqual(GlucoseTrend.flat, GlucoseTrend(byte: 0b1111_0001))
        XCTAssertEqual(GlucoseTrend.flat, GlucoseTrend(byte: 0b1111_0001))
    ...
    func testMidnightSensor() {
        let message =
            PumpMessage(
                rxData: Data(
                    hexadecimalString: "a2594040049c510003310f090501393700025b0101068d262208150034000000700003000f09050000"
                )!
            )!
    ...
    func testSensorEndEmptyReservoir() {
        let message =
            PumpMessage(
                rxData: Data(
                    hexadecimalString: "a259404004fb511205000f090601050502000004000000ff00ffff0040000000711205000f09060000"
                )!
            )!
    ...
    func testSensorOffEmptyReservoir() {
        let message =
            PumpMessage(
                rxData: Data(
                    hexadecimalString: "a259404004ff501219000f09060100000000000400000000000000005e000000720000000000000000"
                )!
            )!
    ...
    func testSensorOffEmptyReservoirSuspended() {
        let message =
            PumpMessage(
                rxData: Data(
                    hexadecimalString: "a25940400401501223000f090601000000000004000000000000000059000000720000000000000000"
                )!
            )!
    ...
    func testClockType24Hour() {
        let message =
            PumpMessage(
                rxData: Data(
                    hexadecimalString: "a295099004b6d5971f1510070a013f3a0002dd020105bd08880825000502000755171e0010070a0000"
                )!
            )!
