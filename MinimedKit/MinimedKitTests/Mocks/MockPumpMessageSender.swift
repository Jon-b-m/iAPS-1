...
class MockPumpMessageSender: PumpMessageSender {
    ...
    func listenForPacket(onChannel _: Int, timeout _: TimeInterval) throws -> RileyLinkBLEKit.RFPacket? {
        // do nothing
        nil
    }
    ...
    func makeMockResponse(_ messageType: MessageType, _ messageBody: MessageBody) -> PumpMessage {
        PumpMessage(packetType: .carelink, address: pumpID, messageType: messageType, messageBody: messageBody)
    }
    ...
    func sendAndListen(_ data: Data, repeatCount _: Int, timeout _: TimeInterval, retryCount _: Int) throws -> RFPacket {
    ...
    func getResponse<T: MessageBody>(
        to message: PumpMessage,
    ...
    func sendAndListenForPacket(
        ...
        do {
            packet = try sendAndListen(
                MinimedPacket(outgoingData: message.txData).encodedData(),
    ...
    func listen(onChannel _: Int, timeout _: TimeInterval) throws -> RFPacket? {
        throw PumpOpsError.noResponse(during: "Tests")
    }

    func send(_: MinimedKit.PumpMessage) throws {
        // Do nothing
    }

    func updateRegister(_: CC111XRegister, value _: UInt8) throws {
        throw PumpOpsError.noResponse(during: "Tests")
    }
    ...
    func setBaseFrequency(_: Measurement<UnitFrequency>) throws {
        throw PumpOpsError.noResponse(during: "Tests")
    }
...
extension MockPumpMessageSender: PumpOpsSessionDelegate {
    func pumpOpsSession(_: PumpOpsSession, didChange _: PumpState) {}

    func pumpOpsSessionDidChangeRadioConfig(_: PumpOpsSession) {}
}
