...
public class MinimedPumpManagerSetupViewController: RileyLinkManagerSetupViewController {
    class func instantiateFromStoryboard() -> MinimedPumpManagerSetupViewController {
        UIStoryboard(name: "MinimedPumpManager", bundle: Bundle(for: MinimedPumpManagerSetupViewController.self))
            .instantiateInitialViewController() as! MinimedPumpManagerSetupViewController
    }
    ...
    override public func viewDidLoad() {
        ...
        if let pumpIDSetupVC = topViewController as? MinimedPumpIDSetupViewController,
