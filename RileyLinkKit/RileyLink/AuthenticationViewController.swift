    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case .Button:
            ...
            case .Empty,
                 ...
                 .Verifying:
                cell.button.setTitle(
                    NSLocalizedString("Add Account", comment: "The title of the button to add the credentials for a service"),
                    forState: .Normal
                )
        ...
        case .Credentials:
            let cell = tableView.dequeueReusableCellWithIdentifier(
                AuthenticationTableViewCell.className,
                forIndexPath: indexPath
            ...
            cell.textField.placeholder = credential.placeholder ?? NSLocalizedString(
                "Required",
