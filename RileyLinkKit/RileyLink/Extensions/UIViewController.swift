...
public extension UIViewController {
     ...
     */
    func presentAlertControllerWithTitle(
        _ title: String?,
        message: String,
        animated: Bool = true,
        completion: (() -> Void)? = nil
        ...
        let action = UIAlertAction(
            title: LocalizedString(
                "com.loudnate.LoopKit.errorAlertActionTitle",
                tableName: "LoopKit",
                value: "OK",
                comment: "The title of the action used to dismiss an error alert"
            ),
            style: .default,
            handler: nil
        )
    ...
    /**
     ...
     - parameter completion: An optional closure to execute after the presentation finishes
     */
    func presentAlertControllerWithError(_ error: Error, animated: Bool = true, completion: (() -> Void)? = nil) {
        ...
        presentAlertControllerWithTitle(
            ...
            message: castedError
                .userInfo[NSLocalizedRecoverySuggestionErrorKey] as? String ?? String(describing: error),
            animated: animated,
    ...
    /**
     ...
     - parameter completion:              An optional closure to execute after the presentation finishes
     */
    func presentViewControllerOnActiveViewController(
