...
struct GetVersion: Command {
    ...
    var data: Data {
        Data([RileyLinkCommand.getVersion.rawValue])
    }
}
...
struct SendAndListen: Command {
    ...
    init(
        ...
        sendChannel: UInt8,
        repeatCount: UInt8,
        delayBetweenPacketsMS: UInt16,
        listenChannel: UInt8,
        timeoutMS: UInt32,
        retryCount: UInt8,
        preambleExtensionMS: UInt16,
...
struct SetLEDMode: Command {
    ...
    var data: Data {
        Data([RileyLinkCommand.setLEDMode.rawValue, led.rawValue, mode.rawValue])
    }
}
...
struct ResetRadioConfig: Command {
    ...
    var data: Data {
        Data([RileyLinkCommand.resetRadioConfig.rawValue])
    }
}
...
struct GetStatistics: Command {
    ...
    var data: Data {
        Data([RileyLinkCommand.getStatistics.rawValue])
    }
}
