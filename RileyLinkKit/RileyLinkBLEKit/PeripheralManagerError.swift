...
extension PeripheralManagerError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .timeout:
            return LocalizedString(
                "RileyLink did not respond in time",
                comment: "PeripheralManagerError.timeout error description"
            )
        case .emptyValue:
            return LocalizedString(
                "Characteristic value was empty",
                comment: "PeripheralManagerError.emptyValue error description"
            )
        case let .unknownCharacteristic(cbuuid):
            return String(
                format: LocalizedString(
                    "Unknown characteristic: %@",
                    comment: "PeripheralManagerError.unknownCharacteristic error description"
                ),
                cbuuid.uuidString
            )
    ...
    public var failureReason: String? {
        ...
        case .unknownCharacteristic:
            return LocalizedString(
                ...
                comment: "Failure reason: unknown peripheral characteristic"
            )
        default:
            return nil
        }
    ...
    public var recoverySuggestion: String? {
        ...
        case .unknownCharacteristic:
            return LocalizedString(
                "Make sure the device is nearby, and the issue should resolve automatically",
                comment: "Recovery suggestion for unknown peripheral characteristic"
            )
        default:
            return nil
        }
