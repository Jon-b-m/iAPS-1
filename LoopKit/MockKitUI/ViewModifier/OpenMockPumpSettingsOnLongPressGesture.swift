...
private struct OpenMockPumpSettingsOnLongPressGesture: ViewModifier {
    ...
    func modifiedContent(content: Content) -> some View {
        ZStack {
            ...
            NavigationLink(
                destination: MockPumpManagerControlsView(pumpManager: pumpManager, supportedInsulinTypes: supportedInsulinTypes),
                isActive: $mockPumpSettingsDisplayed
            ) {
                EmptyView()
            }
