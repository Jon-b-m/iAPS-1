...
class PersistentDeviceLogCriticalEventLogTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let entries = [
            StoredDeviceLogEntry(
                type: .delegateResponse,
                managerIdentifier: "m1",
                deviceIdentifier: "d1",
                message: "Message 1",
                timestamp: dateFormatter.date(from: "2100-01-02T03:08:00Z")!
            ),
            StoredDeviceLogEntry(
                type: .receive,
                managerIdentifier: "m2",
                deviceIdentifier: "d2",
                message: "Message 2",
                timestamp: dateFormatter.date(from: "2100-01-02T03:10:00Z")!
            ),
            StoredDeviceLogEntry(
                type: .send,
                managerIdentifier: "m3",
                deviceIdentifier: "d3",
                message: "Message 3",
                timestamp: dateFormatter.date(from: "2100-01-02T03:04:00Z")!
            ),
            StoredDeviceLogEntry(
                type: .delegate,
                managerIdentifier: "m4",
                deviceIdentifier: "d4",
                message: "Message 4",
                timestamp: dateFormatter.date(from: "2100-01-02T03:06:00Z")!
            ),
            StoredDeviceLogEntry(
                type: .connection,
                managerIdentifier: "m5",
                deviceIdentifier: "d5",
                message: "Message 5",
                timestamp: dateFormatter.date(from: "2100-01-02T03:02:00Z")!
            )
        ]

        persistentDeviceLog = PersistentDeviceLog(
            storageFile: URL(fileURLWithPath: NSTemporaryDirectory()).appendingPathComponent(UUID().uuidString),
            maxEntryAge: .hours(1)
        )
    ...
    func testExportProgressTotalUnitCount() {
        switch persistentDeviceLog.exportProgressTotalUnitCount(
    ...
    func testExport() {
        XCTAssertNil(persistentDeviceLog.export(
            startDate: dateFormatter.date(from: "2100-01-02T03:03:00Z")!,
            endDate: dateFormatter.date(from: "2100-01-02T03:09:00Z")!,
            to: outputStream,
            progress: progress
    ...
    func testExportCancelled() {
        progress.cancel()
        XCTAssertEqual(persistentDeviceLog.export(
            startDate: dateFormatter.date(from: "2100-01-02T03:03:00Z")!,
            endDate: dateFormatter.date(from: "2100-01-02T03:09:00Z")!,
            to: outputStream,
            progress: progress
