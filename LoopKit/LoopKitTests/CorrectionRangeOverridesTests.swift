...
class CorrectionRangeOverridesTests: XCTestCase {
    ...
    func testRawValue() throws {
        ...
        let preMealTargetRange = GlucoseRange(
            rawValue: correctionRangeOverrides.rawValue["preMealTargetRange"] as! GlucoseRange
                .RawValue
        )
        ...
        let workoutTargetRange = GlucoseRange(
            rawValue: correctionRangeOverrides.rawValue["workoutTargetRange"] as! GlucoseRange
                .RawValue
        )
