...
class GlucoseRangeScheduleTests: XCTestCase {
    func testInitializer() {
        ...
        XCTAssertEqual(
            glucoseRangeSchedule!.scheduleRange(),
            HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 75) ...
                HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 150)
        )
    }
    ...
    func testBetweenStartEnd() {
        ...
        let expected = [AbsoluteScheduleValue(
            startDate: start,
            endDate: start.addingTimeInterval(TimeInterval.minutes(50)),
            value: DoubleRange(minValue: 75.0, maxValue: 90.0)
        )]
    ...
    func testQuantityBetweenStartEnd() {
        ...
        let expected = [AbsoluteScheduleValue(
            startDate: start,
            endDate: start.addingTimeInterval(TimeInterval.minutes(50)),
            value: DoubleRange(minValue: 75.0, maxValue: 90.0).quantityRange(for: .millimolesPerLiter)
        )]
    ...
    func testQuantityRangeAtDate() {
        ...
        XCTAssertEqual(
            glucoseRangeSchedule!.quantityRange(at: inDay30Min),
            HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 75.0) ...
                HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 90.0)
        )
        XCTAssertEqual(
            glucoseRangeSchedule!.quantityRange(at: inDay1Hour),
            HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 100.0) ...
                HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 120.0)
        )
        XCTAssertEqual(
            glucoseRangeSchedule!.quantityRange(at: inDay2Hours),
            HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 130.0) ...
                HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 150.0)
        )
    }
    ...
    func testScheduleFor() {
        ...
        let expected = DoubleRange(minValue: 75.0, maxValue: 90.0).quantityRange(for: .milligramsPerDeciliter)
