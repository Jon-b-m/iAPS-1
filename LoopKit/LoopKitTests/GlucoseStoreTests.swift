...
class GlucoseStoreTests: PersistenceControllerTestCase {
    ...
    func testLatestGlucoseIsSetAfterStoreAndClearedAfterPurge() {
        ...
        XCTAssertEqual(storedQuantity, glucoseStore.latestGlucose?.quantity)
...
class GlucoseStoreCriticalEventLogExportTests: PersistenceControllerTestCase {
    ...
    override func setUp() {
        ...
        let samples = [
            NewGlucoseSample(
                ...
                quantity: HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 111),
                condition: nil,
                trend: nil,
                trendRate: nil,
                isDisplayOnly: false,
            ...
            NewGlucoseSample(
                ...
                quantity: HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 112),
                condition: nil,
                trend: .up,
                trendRate: HKQuantity(unit: .milligramsPerDeciliterPerMinute, doubleValue: 1.0),
                isDisplayOnly: false,
                wasUserEntered: false,
                syncIdentifier: "C86DEB61-68E9-464E-9DD5-96A9CB445FD3",
                syncVersion: 2
            ),
            NewGlucoseSample(
                date: dateFormatter.date(from: "2100-01-02T03:04:00Z")!,
                quantity: HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 113),
                condition: nil,
                trend: .up,
                trendRate: HKQuantity(unit: .milligramsPerDeciliterPerMinute, doubleValue: 1.0),
                isDisplayOnly: false,
            ...
            NewGlucoseSample(
                ...
                quantity: HKQuantity(unit: .milligramsPerDeciliter, doubleValue: 114),
                condition: nil,
                trend: .up,
                trendRate: HKQuantity(unit: .milligramsPerDeciliterPerMinute, doubleValue: 1.0),
                isDisplayOnly: false,
                wasUserEntered: false,
                syncIdentifier: "FF1C4F01-3558-4FB2-957E-FA1522C4735E",
                syncVersion: 4
            ),
            NewGlucoseSample(
    ...
    func testExportProgressTotalUnitCount() {
        switch glucoseStore.exportProgressTotalUnitCount(
    ...
    func testExport() {
        XCTAssertNil(glucoseStore.export(
            startDate: dateFormatter.date(from: "2100-01-02T03:03:00Z")!,
            endDate: dateFormatter.date(from: "2100-01-02T03:09:00Z")!,
            to: outputStream,
            progress: progress
    ...
    func testExportCancelled() {
        progress.cancel()
        XCTAssertEqual(glucoseStore.export(
            startDate: dateFormatter.date(from: "2100-01-02T03:03:00Z")!,
            endDate: dateFormatter.date(from: "2100-01-02T03:09:00Z")!,
            to: outputStream,
            progress: progress
