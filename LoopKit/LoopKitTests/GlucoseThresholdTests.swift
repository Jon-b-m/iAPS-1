...
class GlucoseThresholdTests: XCTestCase {
    ...
    func testConvertTo() {
        ...
        XCTAssertEqual(
            glucoseThresholdMGDL.value,
            HKQuantity(unit: .millimolesPerLiter, doubleValue: glucoseThresholdMMOLL.value)
...
class GlucoseThresholdCodableTests: XCTestCase {
    func testCodableMilligramsPerDeciliter() throws {
        try assertGlucoseThresholdCodable(
            GlucoseThreshold(unit: .milligramsPerDeciliter, value: 123),
            encodesJSON: """
            {
              "unit" : "mg/dL",
              "value" : 123
    ...
    func testCodableMillimolesPerLiter() throws {
        try assertGlucoseThresholdCodable(
            GlucoseThreshold(unit: .millimolesPerLiter, value: 6.5),
            encodesJSON: """
            {
