...
class DailyQuantityScheduleCodableTests: XCTestCase {
    func testCodableDouble() throws {
        try assertCodable(
            DailyQuantitySchedule(
                ...
                dailyItems: [
                    RepeatingScheduleValue(startTime: .hours(0), value: 110.3),
            ...
            DailyQuantitySchedule(
                ...
                dailyItems: [
                    RepeatingScheduleValue(
                        startTime: .hours(0),
                        value: DoubleRange(minValue: 100.2, maxValue: 111.2)
                    ),
                    RepeatingScheduleValue(
                        startTime: .hours(6),
                        value: DoubleRange(minValue: 90.5, maxValue: 101.2)
                    ),
                    RepeatingScheduleValue(
                        startTime: .hours(19),
                        value: DoubleRange(minValue: 110.2, maxValue: 121.2)
                    )
                ],
    ...
    func testCodableInt() throws {
        try assertCodable(
            DailyQuantitySchedule(
                unit: .milligramsPerDeciliter,
                dailyItems: [
                    RepeatingScheduleValue(startTime: .hours(0), value: 112),
    ...
    func assertCodable<T>(_ original: DailyQuantitySchedule<T>, encodesJSON string: String) throws
        where T: RawRepresentable & Codable & Equatable
    {
