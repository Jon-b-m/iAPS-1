...
class CachedInsulinDeliveryObjectOperationsTests: PersistenceControllerTestCase {
    ...
    func testCreateAndUpdateFromEntry() {
        ...
        cacheStore.managedObjectContext.performAndWait {
            ...
            object.create(
                from: createEntry,
                by: "Test Providence Identifier",
                at: dateFormatter.date(from: "2020-02-03T04:06:06Z")!
            )
...
private extension CachedInsulinDeliveryObject {
