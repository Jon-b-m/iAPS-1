...
class PumpManagerStatusCodableTests: XCTestCase {
    func testCodable() throws {
        ...
        try assertPumpManagerStatusCodable(
            PumpManagerStatus(
                timeZone: TimeZone(identifier: "America/Los_Angeles")!,
                device: device,
                pumpBatteryChargeRemaining: 0.75,
                basalDeliveryState: .active(
                    dateFormatter
                        .date(from: "2020-05-14T15:56:09Z")!
                ),
                bolusState: .noBolus,
                insulinType: .novolog,
...
class PumpManagerStatusBasalDeliveryStateCodableTests: XCTestCase {
    func testCodableActive() throws {
        try assertPumpManagerStatusBasalDeliveryStateCodable(
            .active(dateFormatter.date(from: "2020-05-14T12:18:09Z")!),
            encodesJSON: """
            {
              "basalDeliveryState" : {
                "active" : {
    ...
    func testCodableSuspended() throws {
        try assertPumpManagerStatusBasalDeliveryStateCodable(
            .suspended(dateFormatter.date(from: "2020-05-14T22:38:19Z")!),
            encodesJSON: """
            {
              "basalDeliveryState" : {
                "suspended" : {
    ...
    private func assertPumpManagerStatusBasalDeliveryStateCodable(
        _ original: PumpManagerStatus.BasalDeliveryState,
...
class PumpManagerStatusBolusStateCodableTests: XCTestCase {
    func testCodableNone() throws {
        try assertPumpManagerStatusBolusStateCodable(
            .noBolus,
            encodesJSON: """
            {
              "bolusState" : "noBolus"
    ...
    private func assertPumpManagerStatusBolusStateCodable(
        _ original: PumpManagerStatus.BolusState,
        encodesJSON string: String
    ) throws {
