...
private extension TherapySettings {
    static var test: TherapySettings {
        ...
        let glucoseTargetRangeSchedule = GlucoseRangeSchedule(
            rangeSchedule: DailyQuantitySchedule(
                ...
                dailyItems: [
                    ...
                    RepeatingScheduleValue(
                        startTime: .hours(8),
                        value: DoubleRange(minValue: 95.0, maxValue: 105.0)
                    ),
                    RepeatingScheduleValue(
                        startTime: .hours(14),
                        value: DoubleRange(minValue: 95.0, maxValue: 105.0)
                    ...
                    RepeatingScheduleValue(
                        startTime: .hours(18),
                        value: DoubleRange(minValue: 90.0, maxValue: 100.0)
                    ),
                    RepeatingScheduleValue(
                        startTime: .hours(21),
                        value: DoubleRange(minValue: 110.0, maxValue: 120.0)
                    )
                ],
                timeZone: timeZone
            )!
        ...
        let carbRatioSchedule = CarbRatioSchedule(
            ...
            dailyItems: [
                RepeatingScheduleValue(startTime: .hours(0), value: 10.0),
