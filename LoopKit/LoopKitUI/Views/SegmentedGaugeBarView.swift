...
public class SegmentedGaugeBarView: UIView {
    ...
    @IBInspectable public var startColor: UIColor {
        get {
            UIColor(cgColor: gaugeLayer.startColor)
        }
        set {
    ...
    @IBInspectable public var endColor: UIColor {
        get {
            UIColor(cgColor: gaugeLayer.endColor)
        }
        set {
    ...
    @IBInspectable public var borderColor: UIColor {
        get {
            UIColor(cgColor: gaugeLayer.gaugeBorderColor)
        }
        set {
    ...
    @IBInspectable public var progress: Double {
        ...
        set {
            if displaysThumb {
                thumb.center.x = interpolatedValue(at: CGFloat(newValue), through: thumbCenterXRange)
                    .clamped(to: thumbCenterXRange)
    ...
    override public class var layerClass: AnyClass {
        SegmentedGaugeBarLayer.self
    }

    private var gaugeLayer: SegmentedGaugeBarLayer {
        layer as! SegmentedGaugeBarLayer
    }
