...
public struct VideoPlayView<ThumbnailContent: View>: View {
    ...
    public init(
        url: URL?,
        thumbnail: @autoclosure @escaping () -> ThumbnailContent,
        includeThumbnailBorder: Bool = true,
        centerThumbnail: Bool = true
    ) {
        self.url = url
    ...
    private init(
        _ other: Self,
        url: URL?? = nil,
        thumbnail: (() -> ThumbnailContent)? = nil,
        hasBeenPlayed: Binding<Bool>? = nil,
        autoPlay: Bool? = nil,
        overrideMuteSwitch: Bool? = nil,
        includeThumbnailBorder: Bool? = nil,
        centerThumbnail: Bool? = nil
    ) {
        ...
        _autoPlay = autoPlay ?? other._autoPlay
        _overrideMuteSwitch = overrideMuteSwitch ?? other._overrideMuteSwitch
    }
