...
public struct CorrectionRangeOverridesEditor: View {
    ...
    public init(
        ...
        _value = State(initialValue: viewModel.correctionRangeOverrides)
    ...
    private func selectableBounds(for _: CorrectionRangeOverrides.Preset) -> ClosedRange<HKQuantity> {
