...
public struct SuspendThresholdEditor: View {
    ...
    public init(
        ...
        _value = State(initialValue: viewModel.suspendThreshold ?? Self.defaultValue(for: viewModel.suspendThresholdUnit))
    ...
    private func continueSaving() {
        viewModel.saveSuspendThreshold(value, displayGlucosePreference.unit)
    }
}
