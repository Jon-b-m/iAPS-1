...
public struct GlucoseTherapySettingInformationView<Content: View>: View {
    ...
    private var illustrationImageName: String {
        "\(therapySetting) \(preferredUnit.description.replacingOccurrences(of: "/", with: ""))"
    }
}

private let mgdLFormatter = QuantityFormatter(for: .milligramsPerDeciliter)
private let mmolLFormatter = QuantityFormatter(for: .millimolesPerLiter)

private extension TherapySetting {
    ...
    var guardrailInformationText: String {
        ...
        case .preMealCorrectionRangeOverride:
            ...
            return lowHighText(
                lowerBoundString: LocalizedString("your Glucose Safety Limit", comment: "Lower bound pre-meal information text"),
