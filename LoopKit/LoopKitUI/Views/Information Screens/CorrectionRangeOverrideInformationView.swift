        ...
        case .preMeal:
            return VStack(alignment: .leading, spacing: 20) {
                ...
                Text(LocalizedString(
                    ...
                    Text(LocalizedString(" lower ", comment: "Information about pre-meal range relative to correction range"))
                    .bold()
                    .italic() +
                    Text(LocalizedString(
        ...
        case .workout:
            return VStack(alignment: .leading, spacing: 20) {
                ...
                Text(LocalizedString(
                    ...
                    Text(LocalizedString(" higher ", comment: "Information about workout range relative to correction range"))
                    .bold()
                    .italic() +
                    Text(LocalizedString(
                        "than your Correction Range.",
