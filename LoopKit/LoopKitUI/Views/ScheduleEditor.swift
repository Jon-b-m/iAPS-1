...
struct ScheduleEditor<Value: Equatable, ValueContent: View, ValuePicker: View, ActionAreaContent: View>: View {
    ...
    init(
        ...
        @ViewBuilder valuePicker: @escaping (_ item: Binding<RepeatingScheduleValue<Value>>, _ availableWidth: CGFloat)
            -> ValuePicker,
            ...
            if isAddingNewItem {
                ...
                NewScheduleItemEditor(
                    ...
                    selectableTimes: scheduleItems.isEmpty
                        ? .only(.hours(0))
                        : .allExcept(Set(scheduleItems.map(\.startTime))),
    ...
    @ViewBuilder private var configurationPage: some View {
        switch mode {
        case .acceptanceFlow:
            page
    ...
    private var page: some View {
        ConfigurationPage(
            ...
            action: {
                ...
                case let .required(alertContent):
    ...
    private var unsupportedValueWarning: some View {
        WarningView(
            title: Text("Unsupported \(title)"),
            caption: Text(LocalizedString(
    ...
    private func alert(for presentedAlert: PresentedAlert) -> SwiftUI.Alert {
        ...
        case let .saveConfirmation(content):
            return Alert(
                ...
                primaryButton: .cancel(Text(LocalizedString(
                    "Go Back",
