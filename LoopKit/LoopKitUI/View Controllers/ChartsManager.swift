...
open class ChartsManager {
    ...
    public init(
        ...
        chartsCache = Array(repeating: nil, count: charts.count)
    ...
    public var fixedHorizontalMargin: CGFloat {
        chartSettings.leading + chartSettings.trailing + labelsWidthY + chartSettings.labelsToAxisSpacingY
    }
    ...
    public func chart(atIndex index: Int, frame: CGRect) -> Chart? {
        ...
        if chartsCache[index] == nil, let xAxisModel = xAxisModel, let xAxisValues = xAxisValues {
            chartsCache[index] = charts[index].generate(
                withFrame: frame,
                xAxisModel: xAxisModel,
                xAxisValues: xAxisValues,
                axisLabelSettings: axisLabelSettings,
                guideLinesLayerSettings: guideLinesLayerSettings,
                colors: colors,
    ...
    private func generateXAxisValues() {
        if let endDate = charts.compactMap(\.endDate).max() {
