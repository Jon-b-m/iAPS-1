...
public struct HistoricalOverrideDetailView: UIViewControllerRepresentable {
    ...
    public func makeUIViewController(context _: Context) -> AddEditOverrideTableViewController {
    ...
    public func updateUIViewController(_: AddEditOverrideTableViewController, context _: Context) {}
}
