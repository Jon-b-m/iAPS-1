...
public final class AuthenticationViewController<T: ServiceAuthenticationUI>: UITableViewController, UITextFieldDelegate {
    ...
    override public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .credentials:
            let cell = tableView.dequeueReusableCell(
                withIdentifier: AuthenticationTableViewCell.className,
                for: indexPath
            ) as! AuthenticationTableViewCell
            ...
            cell.textField.placeholder = credential.field.placeholder ?? LocalizedString(
                "Required",
    ...
    public func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        guard case .unauthorized = state,
              ...
              let cell = tableView
              .cellForRow(at: IndexPath(row: indexPath.row, section: indexPath.section)) as? AuthenticationTableViewCell
        else {
            return
        }
    ...
    public func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        if textField.returnKeyType == .done {
            ...
            if let indexPath = tableView.indexPathForRow(at: point),
               let cell = tableView
               .cellForRow(at: IndexPath(row: indexPath.row + 1, section: indexPath.section)) as? AuthenticationTableViewCell
            {
