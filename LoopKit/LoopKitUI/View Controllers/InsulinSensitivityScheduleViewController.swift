...
public protocol InsulinSensitivityScheduleStorageDelegate {
    func saveSchedule(
        ...
        for viewController: InsulinSensitivityScheduleViewController,
        completion: @escaping (_ result: SaveInsulinSensitivityScheduleResult) -> Void
    )
}
...
public class InsulinSensitivityScheduleViewController: DailyValueScheduleTableViewController {
    ...
    override open func viewDidLoad() {
        ...
        tableView.register(
            SetConstrainedScheduleEntryTableViewCell.nib(),
            forCellReuseIdentifier: SetConstrainedScheduleEntryTableViewCell.className
        )
    ...
    public var unit = HKUnit.milligramsPerDeciliter.unitDivided(by: .internationalUnit())
    ...
    override func insertableIndiciesByRemovingRow(_ row: Int, withInterval timeInterval: TimeInterval) -> [Bool] {
        insertableIndices(for: internalItems, removing: row, with: timeInterval)
    }
    ...
    override open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .schedule:
            let cell = tableView.dequeueReusableCell(
                withIdentifier: SetConstrainedScheduleEntryTableViewCell.className,
                for: indexPath
            ) as! SetConstrainedScheduleEntryTableViewCell
    ...
    override open func tableView(
        ...
        if sourceIndexPath != destinationIndexPath {
            ...
            internalItems[destinationIndexPath.row] = RepeatingScheduleValue(
                startTime: startTime,
                value: internalItems[destinationIndexPath.row].value
            )
    ...
    override open func tableView(
        ...
        guard sourceIndexPath != proposedDestinationIndexPath,
              let cell = tableView.cellForRow(at: sourceIndexPath) as? SetConstrainedScheduleEntryTableViewCell
        else {
