...
public struct FoodTypeRow: View {
    ...
    public init(
        ...
        selectedDefaultAbsorptionTimeEmoji: Binding<String>,
        usesCustomFoodType: Binding<Bool>,
        absorptionTimeWasEdited: Binding<Bool>,
        isFocused: Binding<Bool>,
        defaultAbsorptionTimes: CarbStore.DefaultAbsorptionTimes
    ) {
        _foodType = foodType
        _absorptionTime = absorptionTime
        _selectedDefaultAbsorptionTimeEmoji = selectedDefaultAbsorptionTimeEmoji
        _usesCustomFoodType = usesCustomFoodType
        _absorptionTimeWasEdited = absorptionTimeWasEdited
        ...
        HStack {
            ...
            if usesCustomFoodType {
                RowEmojiTextField(
                    ...
                    isFocused: $isFocused,
                    emojiType: .food,
                    didSelectItemInSection: didSelectEmojiInSection
                )
                .onTapGesture {
...
private enum FoodEmojiShortcut {
    ...
    var emoji: String {
        switch self {
        case let .fast(emoji: emoji):
            return emoji
        case let .medium(emoji: emoji):
            return emoji
        case let .slow(emoji: emoji):
            return emoji
        case .other:
            return "🍽️"
        }
