...
struct RowEmojiTextField: View {
    ...
    class EmojiTextFieldViewModel: ObservableObject, EmojiInputControllerDelegate {
        ...
        func emojiInputControllerDidAdvanceToStandardInputMode(_: EmojiInputController) {
    ...
    init(
        ...
        placeholder: String = "",
        emojiType: EmojiDataSourceType,
        didSelectItemInSection: ((Int) -> Void)? = nil
    ) {
        _text = text
        _isFocused = isFocused
        self.placeholder = placeholder
        self.emojiType = emojiType
        _viewModel = StateObject(wrappedValue: EmojiTextFieldViewModel(didSelectItemInSection: didSelectItemInSection))
    }
