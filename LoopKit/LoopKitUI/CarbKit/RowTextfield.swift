...
struct RowTextField: UIViewRepresentable {
    ...
    var configuration = { (_: CustomInputTextField) in }

    func makeCoordinator() -> Coordinator {
        Coordinator(text: $text, isFocused: $isFocused, maxLength: maxLength)
    }
    ...
    func updateUIView(_ textField: CustomInputTextField, context _: UIViewRepresentableContext<RowTextField>) {
        textField.text = text
