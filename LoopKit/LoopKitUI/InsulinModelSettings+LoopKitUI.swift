    ...
    var subtitle: String {
        ...
        case .lyumjev:
            return LocalizedString(
                ...
                comment: "Subtitle of Lyumjev preset"
            )
        case .afrezza:
            return LocalizedString(
...
public extension WalshInsulinModel {
    static var title: String {
        LocalizedString("Walsh", comment: "Title of insulin model setting")
    }
    ...
    static var subtitle: String {
        LocalizedString(
            "The legacy model used by Loop, allowing customization of action duration.",
            comment: "Subtitle description of Walsh insulin model setting"
        )
    }
