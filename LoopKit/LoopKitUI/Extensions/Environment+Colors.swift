...
private struct ColorPaletteKey: EnvironmentKey {
    static let defaultValue = LoopUIColorPalette(
        guidanceColors: GuidanceColorsKey.defaultValue,
        ...
        loopStatusColorPalette: LoopStatusColorPaletteKey
            .defaultValue,
...
private struct GuidanceColorsKey: EnvironmentKey {
    static let defaultValue = GuidanceColors()
}
...
private struct GlucoseTintColorKey: EnvironmentKey {
    static let defaultValue = Color(.systemTeal)
}
...
private struct LoopStatusColorPaletteKey: EnvironmentKey {
    static let defaultValue = StateColorPalette(
        unknown: .systemGray4,
        normal: .green,
        warning: .yellow,
        error: .red
...
private struct ChartColorPaletteKey: EnvironmentKey {
    static let defaultValue = ChartColorPalette(
        axisLine: .clear,
