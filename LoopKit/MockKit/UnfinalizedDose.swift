    ...
    public var unfinalizedDose: UnfinalizedDose? {
        ...
        if let dose = dose {
            ...
            case .basal:
                return nil
            case .bolus:
                var newDose = UnfinalizedDose(
                    bolusAmount: dose.programmedUnits,
                    startTime: dose.startDate,
                    duration: duration,
                    insulinType: dose.insulinType ?? defaultInsulinType,
            ...
            case .resume:
                return UnfinalizedDose(
                    resumeStartTime: dose.startDate,
                    insulinType: dose.insulinType ?? defaultInsulinType,
            ...
            case .tempBasal:
                return UnfinalizedDose(
                    tempBasalRate: dose.unitsPerHour,
                    startTime: dose.startDate,
                    duration: duration,
                    insulinType: dose.insulinType ?? defaultInsulinType
                )
