...
class GlucoseStoreTestsBase: PersistenceControllerTestCase, GlucoseStoreDelegate {
    ...
    internal let sample1 = NewGlucoseSample(
        date: Date(timeIntervalSinceNow: -.minutes(6)),
    ...
    internal let sample2 = NewGlucoseSample(
        date: Date(timeIntervalSinceNow: -.minutes(2)),
    ...
    internal let sample3 = NewGlucoseSample(
        date: Date(timeIntervalSinceNow: -.minutes(4)),
    ...
    func glucoseStoreHasUpdatedGlucoseData(_: GlucoseStore) {
...
class GlucoseStoreTests: GlucoseStoreTestsBase {
    ...
    func testAddGlucoseSamplesNotification() {
        ...
        wait(
            for: [glucoseSamplesDidChangeCompletion, delegateCompletion!, addGlucoseSamplesCompletion],
            timeout: 10,
            enforceOrder: true
        )
    ...
    func testSyncGlucoseSamples() {
        ...
        glucoseStore.getSyncGlucoseSamples(
            start: Date(timeIntervalSinceNow: -.minutes(5)),
            end: Date(timeIntervalSinceNow: -.minutes(3))
        ) { result in
            switch result {
    ...
    func testPurgeExpiredGlucoseObjects() {
        let expiredSample = NewGlucoseSample(
            date: Date(timeIntervalSinceNow: -.hours(2)),
    ...
    func testPurgeCachedGlucoseObjectsNotification() {
        ...
        wait(
            for: [glucoseSamplesDidChangeCompletion, delegateCompletion!, purgeCachedGlucoseObjectsCompletion],
            timeout: 10,
            enforceOrder: true
        )
...
private func assertEqualSamples(
    _ storedGlucoseSample: StoredGlucoseSample,
