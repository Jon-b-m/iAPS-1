...
extension StoredCarbEntry: Codable {
    public init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            provenanceIdentifier: (try container.decodeIfPresent(String.self, forKey: .provenanceIdentifier)) ?? Self
...
extension StoredCarbEntry {
    ...
    init?(rawValue: RawValue) {
        guard let
            ...
            let createdByCurrentApp = rawValue["createdByCurrentApp"] as? Bool
        else {
            return nil
        }
