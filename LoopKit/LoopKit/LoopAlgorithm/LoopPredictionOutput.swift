...
extension LoopAlgorithmOutput: Codable {
    public init(from decoder: Decoder) throws {
        ...
        predictedGlucose = try container.decode([PredictedGlucoseValue].self, forKey: .predictedGlucose)
        doseRecommendation = try container.decode(AutomaticDoseRecommendation.self, forKey: .doseRecommendation)
    }
...
public extension LoopAlgorithmOutput {
    func printFixture() {
