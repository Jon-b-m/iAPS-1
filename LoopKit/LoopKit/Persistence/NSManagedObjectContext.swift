...
public extension NSManagedObjectContext {
    ...
    func purgeObjects<T: NSManagedObject>(of _: T.Type, matching predicate: NSPredicate? = nil) throws -> Int {
    ...
    func deleteObjects<T>(matching fetchRequest: NSFetchRequest<T>) throws -> Int where T: NSManagedObject {
