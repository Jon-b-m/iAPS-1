...
public protocol RemoteDataService: Service {
    ...
    /**
     ...
     - Parameter completion: The completion function to call with any success or failure.
     */
    func uploadTemporaryOverrideData(
...
public extension RemoteDataService {
    var alertDataLimit: Int? { nil }
    var carbDataLimit: Int? { nil }
    var doseDataLimit: Int? { nil }
    var dosingDecisionDataLimit: Int? { nil }
    var glucoseDataLimit: Int? { nil }
    var pumpEventDataLimit: Int? { nil }
    var settingsDataLimit: Int? { nil }
}
