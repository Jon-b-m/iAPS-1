...
public class IntegralRetrospectiveCorrection: RetrospectiveCorrection {
    ...
    static let correctionTimeConstant = TimeInterval(minutes: 60.0) // was 90.0
    static let differentialGain: Double = 2.0
    static let delta = TimeInterval(minutes: 5.0)
    static let maximumCorrectionEffectDuration = TimeInterval(minutes: 180.0) // was 240.0
    ...
    public func computeEffect(
        ...
        if let pastDiscrepancies = retrospectiveGlucoseDiscrepanciesSummed?.filterDateRange(
            glucoseDate.addingTimeInterval(-Self.retrospectionInterval),
            glucoseDate
        ) {
            ...
            integralCorrectionEffectMinutes = min(
                ...
                IntegralRetrospectiveCorrection.maximumCorrectionEffectDuration.minutes
            )
