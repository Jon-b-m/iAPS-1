...
extension NotificationSettings: Codable {
    public init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            timeSensitiveSetting: try container
                .decodeIfPresent(NotificationSetting.self, forKey: .timeSensitiveSetting) ?? .unknown,
            scheduledDeliverySetting: try container
                .decodeIfPresent(NotificationSetting.self, forKey: .scheduledDeliverySetting) ?? .unknown,
            temporaryMuteAlertsSetting: try container.decodeIfPresent(
                TemporaryMuteAlertSetting.self,
                forKey: .temporaryMuteAlertsSetting
            ) ?? .disabled
        )
    }
